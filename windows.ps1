...
# Notifications: Don't let apps access user notifications: Allow, Deny
...
# App Diagnostics: Don't let apps access app diagnostic information: Allow, Deny
...
# Tasks: Don't allow apps access to tasks: Allow, Deny
...
# Cellular Data: Don't allow apps access to cellular data: Allow, Deny
Set-ItemProperty "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\cellularData" "Value" "Deny"

# My Documents: Don't allow apps access to My Documents folder: Allow, Deny
...
# My Pictures: Don't allow apps access to My Pictures folder: Allow, Deny
...
# My Videos: Don't allow apps access to My Videos folder: Allow, Deny
...
# File System: Don't allow apps access to the file system: Allow, Deny
